...
namespace MarvelCardsWebAPI.Migrations
{
    ...
    [Migration("20200331030205_InitialCreate")]
            ...
            modelBuilder.Entity("XF_Prism_MarvelCards.Model.Hero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DB_CRDAT = new DateTime(2020, 3, 31, 11, 2, 4, 776, DateTimeKind.Local).AddTicks(7058),
                            DB_CRUSR = "David",
                            HeroColor = "#C51925",
                            HeroName = "spider man",
                            Image = "spiderman.png",
                        ...
                        {
                            Id = 2,
                            DB_CRDAT = new DateTime(2020, 3, 31, 11, 2, 4, 777, DateTimeKind.Local).AddTicks(6089),
                            DB_CRUSR = "David",
                            HeroColor = "#DF8E04",
                            HeroName = "iron man",
                            Image = "ironman.png",
                        ...
                        {
                            Id = 3,
                            DB_CRDAT = new DateTime(2020, 3, 31, 11, 2, 4, 777, DateTimeKind.Local).AddTicks(6171),
                            DB_CRUSR = "David",
                            HeroColor = "#5DDF04",
                        ...
                        {
                            Id = 4,
                            DB_CRDAT = new DateTime(2020, 3, 31, 11, 2, 4, 777, DateTimeKind.Local).AddTicks(6177),
                            DB_CRUSR = "David",
                            HeroColor = "#040DDF",
